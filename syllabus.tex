...
\begin{tabular}{c|c|c|c}
	...
	\multirow{2}{*}{10}  & Apr 6 & Model Uncertainty: Iterative Learning Control &  HW4 Out \\
	 & Apr 8 & Stochastic Optimal Control and LQG & \\
	 \hline
	\multirow{2}{*}{11}  & Apr 13 & Approximate DP: Learning Value Functions &  \\
	 & Apr 15 & \textcolor{red}{No Class} &   \\
	 \hline
	\multirow{2}{*}{12}  & Apr 20 & Optimal Control in the Wild: SpaceX \& JPL &  HW4 Due \\
	 & Apr 22 & Optimal Control in the Wild: Legged Robots &   \\
	 \hline
	\multirow{2}{*}{13}  & Apr 27 & Optimal Control in the Wild: Autonomous Driving &  \\
	 & Apr 29 & Optimal Control in the Wild: TBD &   \\
	 \hline
